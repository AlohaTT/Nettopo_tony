...
public class AssymeryTPGF_OptimizeOnePath implements AlgorFunc {
	...
	public AssymeryTPGF_OptimizeOnePath(Algorithm algorithm){
...
//		
		...
		while(label < path.size()-1){
			...
			for(int i=0;i<neighborsID.size();i++){
				...
				for(int j=label+2; j<path.size(); j++){//Ñ°ÕÒ×î´óÒ»Ìø

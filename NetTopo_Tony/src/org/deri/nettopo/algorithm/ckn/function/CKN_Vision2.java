...
public class CKN_Vision2 {
	...
	public  CKN_Vision2( ) throws DuplicateCoordinateException, IOException
	{
		seedNum = SEED_NUM;
		sensorNodeNum = 0;
...
//			logWriter.println(inputK+"\t");
			logWriter.print(CKN_Vision2.D+"\t"+inputK+"\t");
			ckn.beforeWakeUp();
			//before
	...
	public static void main(String[] args) throws DuplicateCoordinateException, IOException {
		...
		{
			filename="E:/ckn/CKN600-"+times+".log";
...
//					{
						CKN_Vision2 ct=new CKN_Vision2();
						CKN_Vision2.D=i;

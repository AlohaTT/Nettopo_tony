...
import org.deri.nettopo.algorithm.TPGFPlus.function.TPGFPlus_ConnectNeighbors;  //境
import org.deri.nettopo.algorithm.TPGFPlus.function.TPGFPlus_FindOnePath_PolicyOne;  //境
...
//			SensorNode_TPGF node = (SensorNode_TPGF)wsn.getNodeByID(nodeID);//------------------------------2011-4-1 境
//	        SensorNode neighbor =(SensorNode) wsn.getNodeByID(nodeID);  //------------------------------2011-4-1 境
			
			int nextOpIndex = label + 1;
//			List<Integer> neighborsID = node.getNeighbors();     //------------------------------2011-4-1 境
			
			
			Integer[] neighborsID=func_connectNeighbors.getNeighbors(nodeID);//------------------------------2011-4-1 境
...
//				SensorNode_TPGF releaseNode = (SensorNode_TPGF)wsn.getNodeByID(id.intValue());//-------------2011-4-12  境

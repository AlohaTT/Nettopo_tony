...
public class TPGFPlus_FindAllPaths_ThreePolicies implements AlgorFunc {
	...
	public TPGFPlus_FindAllPaths_ThreePolicies(Algorithm algorithm) {
	...
	public TPGFPlus_FindAllPaths_ThreePolicies() {
		this(null);
	}
	...
	public int findAllPaths(boolean needPainting) {
		...
		TPGFPlus_FindOnePath_ThreePolicies func_find = (TPGFPlus_FindOnePath_ThreePolicies)getAlgorithm().getFunctions()[1];
		TPGFPlus_OptimizeOnePath_ThreePolicies func_op = (TPGFPlus_OptimizeOnePath_ThreePolicies) getAlgorithm().getFunctions()[2];
		
		func_op.run();//---------------------------------2011-6-30  dong
		...
		while (func_find.findOnePath(false)) {	
			...
			if (needPainting) {
				...
				message.append("  该路径路由代价为：    "+func_op.RouteCost);//  输出路由代价

...
public class Page_NodeAttributes_Parallel extends WizardPage {
	...
	public Page_NodeAttributes_Parallel(){
	...
	public void createControl(Composite parent){
		...
		System.out.println(page_nodeType.getNode().getClass().getName());
		if(page_nodeType.getNode().getClass().getName().contains("Sensor"))
			Property.isSensor=true;
		else
			Property.isSensor=false;
		if(Property.isSensor&&Property.isTPGF)
			{
			System.out.println("in createControl isSensor"+Property.isSensor);
